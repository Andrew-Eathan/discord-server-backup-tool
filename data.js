export const message_save_keys = [
	"bulkDeletable",
	"content",
	"createdTimestamp",
	"editedTimestamp",
...
export const messagekeys = "authorId text, channelId text, type text, content text, createdTimestamp integer, editedTimestamp integer, id text, hasThread integer, pinned integer, system integer, tts integer, activity text"

export const attachmentsKeys = "contentType text, description text, duration real, ephemeral integer, width integer, height integer, id text, name text, proxyURL text, size integer, spoiler integer, url string"
