...
export const messageKeys
	  = "authorId text, channelId text, type text, content text, createdTimestamp integer, editedTimestamp integer, " + 
		"id text, hasThread integer, pinned integer, system integer, tts integer, activity text, attachmentIds text"

export const attachmentsKeys = "messageId text, contentType text, description text, duration real, ephemeral integer, width integer, height integer, id text, name text, proxyURL text, size integer, spoiler integer, url string"
