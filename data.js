...
export const messageKeys
	  = "authorId text, channelId text, type text, content text, createdTimestamp integer, editedTimestamp integer, " + 
		"id text, hasThread integer, pinned integer, system integer, tts integer, activity text, attachmentCount integer"

export const attachmentsKeys = "messageId text, contentType text, description text, duration real, ephemeral integer, width integer, height integer, id text, name text, size integer, spoiler integer"
